...
u(`Class`, [
    ...
    [`CLASS ClassConstructor?`, `,,,@1.origin === "class*", $2.unwrap`, { last: 1 }]
]);
...
u('InterfaceProperty', [
    ['InterfaceKeyword? TypeArguments? Identifier? SoftParams : TypeSentence', '$3.unwrap, $6, $4, { ...$1.unwrap, arguments: $2.unwrap, optional: @2.origin === "?:" }'],
    ...
    [`[ PROPERTY : TypeSentence ] : NEWLINE TypeSentence`, `new yy.Identifier(null, $2).setLoc(@2), $8, , { isDynamicKey: true, keyType: $4 }`],
    [`[ PROPERTY : TypeSentence ] : INDENT TypeSentence OUTDENT`, `new yy.Identifier(null, $2).setLoc(@2), $8, null, { isDynamicKey: true, keyType: $4 }`],
    [`[ Identifier ] : TypeSentence`, `$2, $5, , { isDynamicKey: true, keyType: @2.type }`],
    [`[ Identifier ] : NEWLINE TypeSentence`, `$2, $6, null, { isDynamicKey: true, keyType: @2.type }`],
    [`[ Identifier ] : INDENT TypeSentence OUTDENT`, `$2, $6, null, { isDynamicKey: true, keyType: @2.type }`]
]);
...
u(`TypeSentence`, [
    [`TypeValue`],
    [`TypeSentence TYPE_JOIN TypeValue`, `...$1.contents, $2, $3`],
    [`TypeSentence TYPE_JOIN INDENT TypeValue OUTDENT`, `...$1.contents, $2, $4`],
    [`TypeSentence TYPE_JOIN NEWLINE TypeValue`, `...$1.contents, $2, $4`]
]);
...
u(`TypeObjProps`, [
    ...
    [`TypeObjProps OptComma INDENT TypeObjProp OUTDENT`, `...$1.contents, 2, $4`],
    [`TypeObjProp`]
])
...
u(`TypeObjProp`, [
    ...
    [`PROPERTY :`, `$1, , @2.origin === '?:'`],
    [`Identifier`, `$1`],
    [`[ PROPERTY : TypeSentence ] : TypeSentence`, `$2, $7, , { isDynamicKey: true, keyType: $4 }`],
    [`[ PROPERTY : TypeSentence ] : NEWLINE TypeSentence`, `$2, $8, , { isDynamicKey: true, keyType: $4 }`],
    [`[ PROPERTY : TypeSentence ] : INDENT TypeSentence OUTDENT`, `$2, $8, , { isDynamicKey: true, keyType: $4 }`],
    [`[ Identifier ] : TypeSentence`, `$2, $5, , { isDynamicKey: true, keyType: @2.type }`],
    [`[ Identifier ] : NEWLINE TypeSentence`, `$2, $6, , { isDynamicKey: true, keyType: @2.type }`],
...
u(`TypeArrayItems`, [
    ['TypeSentence'],
    [`TypeArrayItems OptComma NEWLINE TypeSentence`, `...$1.contents, @3.generated && 1 || 0, $4`],
...
u(`Declaration`, [
    ['VARIDENTIFIER', 'new yy.Identifier("VARIDENTIFIER", $1).setLoc(@1)'],
    [`Assignment`]
]);
